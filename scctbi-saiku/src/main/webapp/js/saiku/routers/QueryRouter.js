...
var QueryRouter = Backbone.Router.extend({
    routes: {
        'reports/*query_name': 'open_query',
        //'reports': 'open_query_repository',
    ...
    switch_to_mdx: function( ) {
    	var workspace=Saiku.tabs._tabs[Saiku.tabs.queryCount-1].content;
    	if(!workspace.query){
    		return false;
    	}
    	workspace.toolbar.switch_to_mdx();
    },
    
    save_query: function( ) {
    	var workspace=Saiku.tabs._tabs[Saiku.tabs.queryCount-1].content;
    	workspace.toolbar.save_query();
    }
